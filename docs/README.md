...
Primary entry point for project documentation.
...
- [Software Design Document (PDF)](design/software-design-doc.pdf)
- [Software Design Document Source (LaTeX)](design/software-design-doc-source/main.tex)
- [Transport Application Overview (PDF)](design/Transport%20Application%20Overview.pdf)
...
- [Autocomplete Implementation Summary](features/AUTOCOMPLETE_IMPLEMENTATION_SUMMARY.md)
...
Some documents in this folder were written as point-in-time implementation notes and may contain historical context. For current runtime behavior, prefer:

1. `README.md`
2. `docs/api/API_DOCUMENTATION.md`
3. Backend tests in `backend/tests/`
